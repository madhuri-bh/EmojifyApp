...
import com.google.android.gms.vision.face.FaceDetector;
 ...
 class Emojifier {
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Log.d(TAG, "whichEmoji : smiling prob = " + face.getIsSmilingProbability());
        Log.d(TAG, "whichEmoji : Left eye open prob = " + face.getIsLeftEyeOpenProbability());
        Log.d(TAG, "whichEmoji : Right eye open prob = " + face.getIsRightEyeOpenProbability());
